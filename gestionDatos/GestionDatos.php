    ...
    <div class="gestionContainer">
        <aside class="Container">
            <div class="arriba">
                ...
                <form id="formUnidad" action="guardar_unidad.php" method="POST" class="form">
                    ...
                    <table class="tablaModerna">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button class="btnUltimo borrar" onclick="eliminar('vehiculo', <?= $u['id_placas'] ?>)">🗑️</button></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
    ...
    <div class="gestionContainer">
        <aside class="Container">
            <div class="arriba">
                ...
                <form action="guardar_chofer.php" method="POST" class="form">
                    <div class="contenedorInput">
