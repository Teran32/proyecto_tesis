...
$options->set('isRemoteEnabled', true); // <--- ESTO ES VITAL
$options->set('chroot', realpath(__DIR__ . '/..')); // <--- Permite subir un nivel en las carpetas
$dompdf = new Dompdf($options);



// 6. Diseño del HTML (Lo que se verá en el PDF)
$html = '
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        ...
        .galeria-inspeccion { margin-top: 15px; }
        .galeria-inspeccion .img-inspeccion { display: inline-block; margin: 5px; border: 1px solid #ccc; padding: 2px; background: #fff; }
        .galeria-inspeccion img { max-width: 120px; max-height: 120px; }
